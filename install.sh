...
confFiles='buscar.sh construir.sh info.sh info.txt eliminar.sh Instalar.sh actualizar.sh versionar.sh usage.sh CompararVersiones.sh VerificarPaqueteBD.sh'
